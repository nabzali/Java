...
public class PGPFile
{
    public boolean openReadFile( String strFileName )
    {
        ...
        if ( br != null )
            closeReadFile(); //basically br should equal null when first opening a new file. because br hasnt been created
        try
        {
        ...
        {
            return false; //false is returned - there is an exception, i.e the file cannot be opened
        }
        return true; // very easy - true is returned to signify that the file CAN be opened
    }
